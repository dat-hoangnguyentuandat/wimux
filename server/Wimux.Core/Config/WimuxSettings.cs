...
public class WimuxSettings
{
    ...
    // (which uses it as "paste") and only Shift+Right opens wimux's menu. When
    // true, a plain right-click always opens wimux's menu everywhere — we
