...
/// Completed commands are persisted to daily JSONL files under %LOCALAPPDATA%/wimux/logs.
/// </summary>
public class CommandLogService
{
    ...
    private static readonly string LogsDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "wimux", "logs");
