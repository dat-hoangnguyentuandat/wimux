using Wimux.Web.Services.Browser;
...
public class BrowserManagerTests
{
    private sealed class FakeProvider : IBrowserProvider
    {
        ...
        public Task SuppressBrowserUiAsync(CancellationToken ct = default) => Task.CompletedTask;
    ...
    public async Task CloseClientTab_ClosesUnderlyingCdpTab()
    {
        ...
        p.Tabs.Should().NotContainKey(t.Value.tabId, "closing the wimux pane must close the live Chrome tab");
