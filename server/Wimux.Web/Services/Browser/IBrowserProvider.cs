...
public interface IBrowserProvider : IAsyncDisposable
{
    ...
    /// <summary>
    /// Re-apply provider-specific window hiding after a CDP command activates the browser UI.
    /// </summary>
    Task SuppressBrowserUiAsync(CancellationToken ct = default);
    ...
    /// the user closes the wimux live-browser view so no off-screen browser window
