...
public static class BrowserEndpointExtensions
{
    ...
    public static void MapBrowserEndpoints(this WebApplication app)
    {
        ...
        // Close the live Chrome tab bound to a wimux client (pane) tab id.
        ...
        // ── Screencast view: stream a tab into the wimux panel ───────────
        ...
        app.Map("/ws/browser/view", async (HttpContext ctx, BrowserManager m) =>
        {
            ...
            try
            {
                ...
                cast = new BrowserScreencastSession(m.SuppressBrowserUiAsync);
